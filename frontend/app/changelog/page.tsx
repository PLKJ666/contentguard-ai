    ...
    <div className="min-h-screen bg-bg-page">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-text-primary mb-4">ContentGuard AI</h1>
          {latestVersion?.tag && (
            <div className="mb-4">
          ...
          <p className="text-text-secondary">AI 营销内容合规审核系统</p>
        </div>

        {/* 产品信息卡 */}
        <div className="bg-bg-card border border-border-subtle rounded-2xl px-6 mb-8">
